       ...
       <form class="edit_profile_form" action="<?php echo $_SERVER['PHP_SELF'].'?id='.$id; ?>" method="post" enctype="multipart/form-data">
         <div class="fam_bac_sub">
           ...
           <div class="fam_bac_sub_inner">
             ...
             <div class="address">
               <input type="text" class="form-control" name="address" placeholder="Address"  value="<?php if(isset($user->address)) echo $user->address; ?>">
             </div>
             <div class="phone">
               <input type="text" class="form-control" name="phone_number" placeholder="Phone Number"  value="<?php if(isset($user->phone_number)) echo $user->phone_number; ?>">
             </div>
             <div class="nid">
               <input type="text" class="form-control" name="nid" placeholder="National ID Number"  value="<?php if(isset($user->nid))   echo $user->nid; ?>">
             </div>
